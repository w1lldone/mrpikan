...
--
-- Host: 127.0.0.1
-- Generation Time: 30 Mar 2017 pada 16.33
-- Versi Server: 5.6.26
-- PHP Version: 5.6.12
...
-- Database: `mrp_ikan`
--
CREATE DATABASE IF NOT EXISTS `mrp_ikan` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `mrp_ikan`;
...
-- Trigger `margin`
--
DROP TRIGGER IF EXISTS `ps_harga`;
DELIMITER $$
...
-- Trigger `rata`
--
DROP TRIGGER IF EXISTS `rata_h1`;
DELIMITER $$
...
DROP TABLE IF EXISTS `transaksi2`;
