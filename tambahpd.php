<?php if($_GET['act']=='input'){ ?>            
            <div class="row">
                <div class="col-lg-6 col-lg-offset-3">
                    <h1 class="page-header">Tambah Anggota Pedagang</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form method="post" role="form" action="input_anggota.php?act=inputpd">
                                        <label>Nama</label>
...
<?php } // if act input 
        ...
        $id=$_GET['id'];    
        $sql="select * from pedagang where idpd = $id";
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form method="post" role="form" action="input_anggota.php?act=editpd">
                                        <label>Nama</label>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
